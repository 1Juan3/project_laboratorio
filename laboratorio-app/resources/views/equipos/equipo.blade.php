        ...
        <link rel="stylesheet" href="{{ asset('css/sustancia.css') }}">
            ...
            <div class="card  mx-auto " style="width: 20rem; margin-top:20px; margin-bottom: 20px; ">
                ...
                <div class="card-body" style="display: flex; flex-direction: column;">
                    <a href="{{ route('getFacturaEquipo', $item->factura) }} " target=" _blank" class="card-link">Ver la factura del equipo</a>
                    <a href="{{ route('getManualEquipo', $item->manual_usuario) }} " target=" _blank" class="card-link">Ver el manual de usuario</a>
                </div>
                <a href="{{ route('verHv', $item->id) }}"type="button" class="btn btn-outline-warning" style="margin-bottom: 10px">Hoja de vida</a>
