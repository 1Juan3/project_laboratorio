            ...
            <div class="modal-dialog modal-xl ">
                <div class="modal-content container-fluid">
                    ...
                    <div class="modal-body ">
                        ...
                        <form action="{{ route('agregarInformacionHv', ['id' => $id]) }}" method="POST"
                            enctype="multipart/form-data" class="row">
                            @csrf

                            <div class="form-floating mb-3 col-6 ps-1">
                                <input type="text" class="form-control" id="floatingInput1" name="nombre_equipo"
                                    value="{{ old('nombre_equipo', $hv->nombre_equipo) }}"
                                    placeholder="Nombre del equipo ">
                                <label for="floatingInput ">Nombre del equipo</label>
                            </div>
                            <div class="form-floating mb-3  col-6 ps-1  ">
                                <input type="text" class="form-control" id="floatingInput1" name="marca_fabricante"
                                    value="{{ old('marca_fabricante', $hv->marca_fabricante) }}"
                                    placeholder="Marca del Fabricante ">
                                <label for="floatingInput">Marca del Fabricante</label>
                            </div>
                            <div class="form-floating mb-3 col-6 ps-1 ">
                                <input type="text" class="form-control" id="floatingInput1" name="referencia"
                                    value="{{ old('referencia', $hv->referencia) }}" placeholder="Referencia ">
                                <label for="floatingInput">Referencia</label>
                            </div>
                            <div class="form-floating mb-3 col-6 ps-1">
                                <input type="text" class="form-control" id="floatingInput1" name="modelo"
                                    value="{{ old('modelo', $hv->modelo) }}" placeholder="Modelo ">
                                <label for="floatingInput">Modelo</label>
                            </div>
                            <div class="form-floating mb-3 col-6 ps-1">
                                <input type="text" class="form-control" id="floatingInput1" name="numero_serie"
                                    value="{{ old('modelo', $hv->numero_serie) }}" placeholder="Numero de serie">
                                <label for="floatingInput">Numero de serie</label>
                            </div>
                            <div class="form-floating mb-3 col-6 ps-1">
                                <input type="text" class="form-control" id="floatingInput1"
                                    name="numero_codificacion" value="{{ old('modelo', $hv->numero_codificacion) }}"
                            ...
                            <div class="form-floating mb-3 col-6 ps-1">
                                <input type="date" class="form-control" id="floatingInput1"
                                    name="fecha_inicio_servicio" value="{{ old('modelo', $hv->fecha_inicio_servicio) }}"
                                    placeholder="Fecha inicio en servicio ">
                                <label for="floatingInput">Fecha inicio en servicio</label>
                            </div>
                            <div class="form-floating mb-3 col-6 ps-1">
                                <input type="text" class="form-control" id="floatingInput1"
                                    name="condiciones_utilizacion"
                                    value="{{ old('modelo', $hv->condiciones_utilizacion) }}"
                                    placeholder="Condiciones de utilizacion">
                                <label for="floatingInput">Condiciones de utilizacion</label>
                            </div>
                            <div class="form-floating mb-3 col-6 ps-1">
                                <input type="text" class="form-control" id="floatingInput1" name="valor_equipo"
                                    value="{{ old('modelo', $hv->valor_equipo) }}"
                                    placeholder="Valor del equipo y Factura de compra">
                                <label for="floatingInput">Valor del equipo y Factura de compra</label>
                            </div>
                            <div class="form-floating mb-3 col-6 ps-1">
                                <input type="text" class="form-control" id="floatingInput1" name="pais_fabricacion"
                                    value="{{ old('modelo', $hv->pais_fabricacion) }}"
                                    placeholder="Pais de fabricacion ">
                                <label for="floatingInput">Pais de fabricacion</label>
                            </div>
                            <div class="form-floating mb-3 col-6 ps-1">
                                <input type="text" class="form-control" id="floatingInput1" name="descripcion"
                                    value="{{ old('modelo', $hv->descripcion) }}" placeholder="Descripcion ">
                                <label for="floatingInput">Descripcion</label>
                            </div>
                            <div class="form-floating mb-3 col-6 ps-1">
                                <input type="text" class="form-control" id="floatingInput1"
                                    value="{{ old('modelo', $hv->grupos_calibracion) }}" name="grupos_calibracion"
                                    placeholder="Grupos de calibracion">
                                <label for="floatingInput">Grupos de calibracion</label>
                            </div>
                            <div class="form-floating mb-3 col-6 ps-1">
                                <input type="text" class="form-control" id="floatingInput1"
                                    value="{{ old('modelo', $hv->intervalo_calibracion) }}"
                                    name="intervalo_calibracion" placeholder="Intervalo de calibracion">
                                <label for="floatingInput">Intervalo de calibracion</label>
                            </div>
                            <div class="form-floating mb-3 col-6 ps-1">
                                <input type="date" class="form-control" id="floatingInput1"
                                    value="{{ old('modelo', $hv->fecha_calibracion) }}" name="fecha_calibracion"
                                    placeholder="Fecha de calibracion">
                                <label for="floatingInput">Fecha de calibracion</label>
                            </div>
                            <div class="form-floating mb-3 col-6 ps-1">
                                <input type="text" class="form-control" id="floatingInput1"
                                    value="{{ old('modelo', $hv->modelo) }}" name="modelo"
                                    placeholder="Marca del Fabricante">
                                <label for="floatingInput">Marca del Fabricante</label>
                            </div>
                            <div class="form-floating mb-3 col-6 ps-1">
                                <input type="text" class="form-control" id="floatingInput1"
                                    value="{{ old('modelo', $hv->procedimiento_calibracion) }}"
                            ...
                            <div class="form-floating mb-3 col-6 ps-1">
                                <input type="text" class="form-control" id="floatingInput1"
                                    value="{{ old('modelo', $hv->resultado_calibracion) }}"
                            ...
                            <div class="form-floating mb-3 col-6 ps-1">
                                <input type="text" class="form-control" id="floatingInput1"
                                    value="{{ old('modelo', $hv->naturaleza_calibracion) }}"
                                    name="naturaleza_calibracion" placeholder="Naturaleza de calibracion ">
                                <label for="floatingInput">Naturaleza de calibracion</label>
                            </div>
                            <div class="form-floating mb-3 col-6 ps-1">
                                <input type="text" class="form-control" id="floatingInput1"
                                    value="{{ old('modelo', $hv->localizacion) }}" name="localizacion"
                                    placeholder="Localizacion ">
                                <label for="floatingInput">Localizacion</label>
                            </div>
                            <div class="form-floating mb-3 col-6 ps-1">
                                <input type="text" class="form-control" id="floatingInput1"
                                    value="{{ old('modelo', $hv->limites_empleo) }}" name="limites_empleo"
                                    placeholder="Limites de empleo ">
                                <label for="floatingInput">Limites de empleo</label>
                            </div>
                            <div class="form-floating mb-3 col-6 ps-1">
                                <input type="text" class="form-control" id="floatingInput1"
                                    value="{{ old('modelo', $hv->condiciones_uso_almacenamiento) }}"
                                    name="condiciones_uso_almacenamiento"
                                    placeholder="Condiciones de uso y almacenamiento ">
                                <label for="floatingInput">Condiciones de uso y almacenamiento</label>
                            </div>
                            <div class="form-floating mb-3 col-6 ps-1">
                                <input type="text" class="form-control" id="floatingInput1"
                                    value="{{ old('modelo', $hv->observaciones) }}" name="observaciones"
                                    placeholder="Observaciones ">
                                <label for="floatingInput">Observaciones</label>
                            </div>
                            <div class="form-floating mb-3 col-6 ps-1">
                                <input type="text" class="form-control" id="floatingInput1"
                                    value="{{ old('modelo', $hv->nombre_equipo) }}" name="nombre_equipo"
                                    placeholder="Nombre del equipo ">
                                <label for="floatingInput">Nombre del equipo</label>
                            </div>
                            <div class="form-floating mb-3 col-6 ps-1">
                                <input type="text" class="form-control" id="floatingInput1"
                                    value="{{ old('modelo', $hv->numero_inventario) }}" name="numero_inventario"
                                    placeholder="Numero de inventario ">
                                <label for="floatingInput">Numero de inventario</label>
                            </div>
                            <div class="form-floating mb-3 col-6 ps-1">
                                <input type="date" class="form-control" id="floatingInput1"
                                    value="{{ old('modelo', $hv->fecha_ultima_calibracion) }}"
                                    name="fecha_ultima_calibracion" placeholder="Fecha ultima calibracion ">
                                <label for="floatingInput">Fecha ultima calibracion</label>
                            </div>
                            <div class="form-floating mb-3 col-6 ps-1">
                                <input type="date" class="form-control" id="floatingInput1"
                                    value="{{ old('modelo', $hv->fecha_proxima_calibracion) }}"
                            ...
                            <div class="form-floating mb-3 col-6 ps-1">
                                <input type="text" class="form-control" id="floatingInput1"
                                    value="{{ old('modelo', $hv->limitaciones_uso) }}" name="limitaciones_uso"
                                    placeholder="Limitaciones de uso ">
                                <label for="floatingInput">Limitaciones de uso</label>
                            </div>
                            <div class="form-floating mb-3 col-6 ps-1">
                                <input type="date" class="form-control" id="floatingInput1"
                                    value="{{ old('modelo', $hv->fecha_mantenimiento) }}" name="fecha_mantenimiento"
                                    placeholder="Fecha matenimiento">
                                <label for="floatingInput">Fecha mantenimiento</label>
                            </div>
                            <div class="form-floating mb-3 col-6 ps-1">
                                <input type="text" class="form-control" id="floatingInput1"
                                    value="{{ old('modelo', $hv->actividad_realizada) }}" name="actividad_realizada"
                                    placeholder="Actividad realizada ">
                                <label for="floatingInput">Actividad realizada</label>
                            </div>
                            <div class="form-floating mb-3 col-6 ps-1">
                                <input type="text" class="form-control" id="floatingInput1"
                                    value="{{ old('modelo', $hv->quien_realizo_mantenimiento) }}"
                            ...
                            <div class="form-floating mb-3 col-6 ps-1">
                                <input type="text" class="form-control" id="floatingInput1"
                                    value="{{ old('modelo', $hv->observaciones_calibracion) }}"
    ...
    <section class="tabla container-fluid ">
        <div class="bd-example row col-12 col-sm-10 col-md-9 col-lg-8 col-xl-7 col-xxl-6 mx-auto ">
            <table class="table table-bordered ">
                <thead>
                    <tr>
                        <th scope="col" colspan="2" style="text-align: center;">Hoja de vida equipo
                            {{ $hv->nombre_equipo }}</th>
                    </tr>
                    <tr>
